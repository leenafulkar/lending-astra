  ...
  const jsonData = [
    {
      ...
      introBalanceTransferAPR:
        "0% APR for 12 months on balance transfers then a 13.50%-17.99% variable APR applies",
      ...
      whyWeLikeIt:
        "The ESL Visa® Credit Card prioritizes savings with minimal fees. You'll enjoy no balance transfer, annual, or cash advance fees. Additionally, you'll have a one-year grace period to settle your balance transfer before transitioning to a low ongoing variable APR ranging from 13.50% to 17.99%.",
      cardDetails: [
      ...
      disclaimer:
        "*The details regarding the ESL Visa® Credit Card have been gathered by LendingTree and have not undergone review or provision by the card issuer prior to publication. Terms and conditions apply.",
    },
    {
      id: 2,
      ...
      introBalanceTransferAPR:
        "0% for 12 months on balance transfers then a Variable 16.50%-18.00% APR applies",
      ...
      disclaimer:
        "*The details regarding the Hudson Valley Visa® Platinum Credit Card have been compiled by LendingTree and have not undergone review or provision by the card issuer prior to publication. Terms and conditions apply.",
    },
    {
      id: 3,
      ...
      introBalanceTransferAPR:
        "0% Intro APR for 12 months on balance transfers then a 13.24% to 25.24% variable APR applies",
      regularBalanceTransferAPR: "13.24% to 25.24% variable",
      rewardsRate: "N/A",
      annualFee: "$0",
      recommendedCredit: "N/A",
      pros: ["$0 annual fee", "No balance transfer fee", "Low standard APR"],
      cons: [
        "No rewards",
        "No sign-up bonus",
        "Membership at a credit union is required",
      ...
      disclaimer:
        "*Details regarding the BECU Visa Credit Card have been gathered by LendingTree and have not undergone review or provision by the card issuer before publication. Terms and conditions apply.",
    },
    {
      id: 4,
      ...
      introBalanceTransferAPR:
        "4.99% Introductory APR for a period of 18 billing cycles, then a 13.24%-18.00% Variable APR applies",
      ...
      cons: ["No rewardsNo 0% intro APR", "No rewards", "No sign-up bonus"],
      whyWeLikeIt:
        "Unlike several other cards listed, the Kinecta MyPower Credit Card is available to individuals across the U.S. While it doesn't provide a 0% introductory APR period for balance transfers, the introductory APR of 4.99% for the first 18 billing cycles can assist in reducing high-interest credit card debt. Following the introductory period, a low ongoing variable APR of 13.24%-18.00% applies to any remaining balance.",
      cardDetails: [
      ...
      disclaimer:
        "*Details concerning the Kinecta MyPower Credit Card have been gathered by LendingTree and have not been reviewed or provided by the card issuer before publication. Terms and conditions apply.",
    },
    {
      id: 5,
      ...
      introBalanceTransferAPR:
        "0.99% introductory APR for 12 months for balance transfers requested within 60 days of account opening then a 11.24% to 18.00% (variable) APR applies",
      ...
      disclaimer:
        "*Details regarding the Navy Federal Platinum Credit Card have been gathered by LendingTree and have not been reviewed or provided by the card issuer before publication. Terms and conditions apply.",
    },
    {
      id: 6,
      ...
      introBalanceTransferAPR:
        "4.9% until Dec. 31 2025 on balance transfers, then a 12.90% Variable APR applies",
      ...
      whyWeLikeIt:
        "The PSECU Visa® Classic is an excellent option for Pennsylvania residents seeking a no-fee balance transfer card with competitive rates. Additionally, with the potential to qualify for a credit line of up to $30,000, this card can be a fantastic choice for individuals needing to transfer a substantial balance.",
      cardDetails: [
        "No annual fee",
      ...
      disclaimer:
        "*Details regarding the PSECU Visa® Classic have been compiled by LendingTree and have not undergone review or provision by the card issuer before publication. Terms and conditions apply.",
    },
    {
      id: 7,
      ...
      disclaimer:
        "*Details concerning the PFFCU Contactless Rewards Visa have been gathered by LendingTree and have not been reviewed or provided by the card issuer before publication. Terms and conditions apply.",
    },
    {
      id: 8,
      ...
      introBalanceTransferAPR:
        "4.99% intro APR for 12 months on balance transfers then a 17.25%-21.75% Variable APR applies",
      ...
      whyWeLikeIt:
        "For those residing in eligible areas, the OnPoint Signature Visa® with Cash Back Rewards offers a chance to benefit from a low introductory APR on balance transfers. Additionally, you'll earn 2% cash back on all purchases, a rate that rivals some of the best cash back credit cards available.",
      cardDetails: [
      ...
      disclaimer:
        "*Details regarding the OnPoint Signature Visa® with Cash Back Rewards have been compiled by LendingTree and have not undergone review or provision by the card issuer before publication. Terms and conditions apply.",
    },
    {
      id: 9,
      ...
      introBalanceTransferAPR:
        "2.99%-4.99% for the first 12 months on balance transfers then a 13.40%-18.00% Variable APR applies",
      ...
      cons: ["No rewards", "No sign-up bonus", "No 0% intro APR"],
      whyWeLikeIt:
        "The BethPage Mastercard® Low Rate Credit Card stands out as one of the few cards accessible to consumers nationwide. It features a low introductory APR on balance transfers, coupled with a competitive ongoing APR post-promotional period. Additionally, it offers the potential for a substantial credit limit, with qualifications available for credit lines of up to $35,000.",
      cardDetails: [],
      disclaimer:
        "*Details regarding the BethPage Mastercard® Low Rate Credit Card have been gathered by LendingTree and have not undergone review or provision by the card issuer before publication. Terms and conditions apply.",
    },
    {
      id: 10,
      ...
      introBalanceTransferAPR:
        " 0% introductory APR for the first 12 billing cycles for balances transferred within 60 days from account opening then a 20.24%–29.99% Variable APR applies",
      regularBalanceTransferAPR: "20.24%–29.99%",
      rewardsRate:
        "Earn 1.5 Loyalty Points on every net $1 spent up to $40,000 and 2 Loyalty Points on every net $1 spent over $40,000",
      annualFee: "$0",
      recommendedCredit: "N/A",
      pros: [
      ...
      disclaimer:
        "*Details regarding the Edward Jones Business Plus MasterCard Credit Card have been compiled by LendingTree and have not been reviewed or provided by the card issuer before publication. Terms and conditions apply.",
    },
    {
      id: 11,
      ...
      introBalanceTransferAPR:
        "1.99% APR for 12 months on balance transfers then a Variable 14.75% to 24.25% APR applies",
      regularBalanceTransferAPR: "14.75% to 24.25% APR",
      rewardsRate: "N/A",
      annualFee: "$0",
      recommendedCredit: "N/A",
      pros: ["$0 annual fee", " balance transfer fee", "Earns rewards"],
      cons: ["No 0% intro APR", "Rewards have limited redemptions"],
      whyWeLikeIt:
        "The CEFCU World Mastercard could be perfect if you plan to travel after paying off your transferred debt. Along with its introductory APR offers, it provides elevated rewards on travel-related purchases such as fuel, dining, and hotels. Additionally, you’ll benefit from various travel perks, including concierge service and exclusive offers from Mastercard.",
      cardDetails: ["N/A"],
      disclaimer:
        "*Details regarding the CEFCU World Mastercard have been compiled by LendingTree and have not been reviewed or provided by the card issuer before publication. Terms and conditions apply.",
    },
    {
      id: 12,
      ...
      introBalanceTransferAPR:
        "1.99% introductory APR for 12 months on balance transfers then a 15.75%-25.25% Variable APR applies",
      ...
      cons: ["No intro 0% APR", "Rewards have limited redemptions"],
      whyWeLikeIt:
        "The CEFCU Cash Back Credit Mastercard provides an introductory APR on balance transfers for one year, followed by an ongoing variable APR of 15.75% to 25.25%. This card remains valuable even after you pay off your balance, as it offers 1.5% cash back on every purchase.",
      cardDetails: ["N/A"],
      disclaimer:
        "*Details regarding the CEFCU Cash Back Credit Mastercard have been gathered by LendingTree and have not been reviewed or provided by the card issuer before publication. Terms and conditions apply.",
    },
    {
      id: 13,
      ...
      introBalanceTransferAPR:
        "1.99% for 12 months on balance transfers then a Variable 14.75%-24.25% APR applies",
      regularBalanceTransferAPR: "14.75%-24.25% APR",
      rewardsRate:
        "Earn 1 Point for every dollar of net purchases on your Card.",
      annualFee: "$0",
      recommendedCredit: "N/A",
      pros: [
        "$0 annual fee",
      ...
      cons: ["No 0% intro APR", "No rewards"],
      whyWeLikeIt:
        "The CEFCU Rewards Credit Mastercard is a suitable option if you want to transfer high-interest debt to a card with a low interest rate. Additionally, you'll earn rewards on every purchase.",
      cardDetails: ["N/A"],
      disclaimer:
        "*Details concerning the CEFCU Rewards Credit Mastercard have been compiled by LendingTree and have not undergone review or provision by the card issuer before publication. Terms and conditions apply.",
    },
  ];
  ...
  return (
    <>
      ...
      <Container sx={{ marginTop: "40px" }}>
        ...
        >
          Top balance transfer cards with no transfer fee
        </Typography>
        <br />
        {jsonData.map((card) => (
          <Card
        ...
        <Grid container spacing={2}>
          <Grid item xs={12}>
            ...
            >
              The top no-fee balance transfer credit cards typically originate
              from credit unions, necessitating membership for all cardholders.
              Obtaining membership may pose a challenge if you do not reside
              near a specific credit union or are not employed by a qualifying
              organization, such as the military or an affiliated company.
              However, there are alternative methods you can explore:
            </Typography>
            <Typography
              sx={{
                fontSize: "14px",
            ...
            >
              ...
              <span style={{ fontWeight: "bold" }}>
                Apply alongside a family member residing near the credit union.{" "}
              </span>{" "}
              Several credit unions impose location-based eligibility
              restrictions, although some permit membership through family
              members residing in an eligible city, county, or state.
            </Typography>
            <Typography
              sx={{
                fontSize: "14px",
            ...
            >
              2.&nbsp;&nbsp;
              <span style={{ fontWeight: "bold" }}>
                Qualify through professional, religious, or cultural
                associations.{" "}
              </span>
              Numerous credit unions serve distinct groups, such as educators,
              craftsmen, and members of particular faith and cultural
              communities. Conduct a brief online search for credit unions
              extending membership to groups aligning with your identity.
            </Typography>
            <Typography
              sx={{
                fontSize: "14px",
            ...
            >
              3.&nbsp;&nbsp;
              <span style={{ fontWeight: "bold" }}>
                Meet additional membership criteria.{" "}
              </span>
              Certain credit unions extend membership to individuals who
              establish accounts with them or contribute to partner
              organizations. For instance, you can become a member of Bethpage
              Federal Credit Union by initiating a savings account with a
          ...
          <Grid item xs={12}>
            ...
            >
              Top balance transfer credit cards featuring extended 0% APR
              periods
            </Typography>
            <Typography
              sx={{
            ...
            >
              These selected balance transfer credit cards, although they do
              incur balance transfer fees, are worth exploring. Generally, they
              are more accessible as they are issued by national banks rather
              than credit unions. Moreover, they offer extended 0% interest
              introductory periods, potentially resulting in significant savings
              on interest payments if you manage to clear your balance before
              the introductory period concludes. Additionally, many of these
              cards come with rewards programs, adding value even after you've
              settled your balance.
            </Typography>
          </Grid>
        </Grid>
        {/* ---------------------------------------------------------- */}
