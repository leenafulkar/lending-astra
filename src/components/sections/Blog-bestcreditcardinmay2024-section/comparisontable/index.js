...
const rows = [
    ...
    createData(
       ...
       <><img src={Venture_logo} alt="img" width={183} height={114} style={{margin:'0px 0px 8px'}} />
    ...
    createData(
      ...
      <><img src={flex_default_logo} alt="img" width={183} height={114} style={{margin:'0px 0px 8px'}} />
      <Typography sx={{fontSize:'12px',color:'#0069BA',fontWeight:'bold'}}>Chase Freedom Flex℠*</Typography>
      </> ,
       
        <><Rating name="read-only" value={4.5} readOnly  precision={0.5} /><br/><Typography sx={{color:'#4B5155',fontSize:'12px'}}>Best no-fee rewards credit card</Typography></>,   
    ...
    createData(
      ...
      <><img src={ink_business_preferred_logo} alt="img" width={183} height={114} style={{margin:'0px 0px 8px'}} />
      <Typography sx={{fontSize:'12px',color:'#0069BA',fontWeight:'bold'}}>Ink Business Preferred® Credit Card</Typography>
      </> ,
        
        <><Rating name="read-only" value={4.5} readOnly  precision={0.5} /><br/><Typography sx={{color:'#4B5155',fontSize:'12px'}}>Top business rewards credit card</Typography></>,        
   ...
   //  Row 4
    createData( <><img src={citi_custom_logo} alt="img" width={183} height={114} style={{margin:'0px 0px 8px'}} />
    <Typography sx={{fontSize:'12px',color:'#0069BA',fontWeight:'bold'}}>Citi Custom Cash® Card</Typography>
    </> ,
    <><Rating name="read-only" value={4.5} readOnly  precision={0.5} /><br/><Typography sx={{color:'#4B5155',fontSize:'12px'}}>Best gas rewards credit card</Typography></>,       
...
//  Row 5
    createData(<><img src={blue_cash_preferred_logo} alt="img" width={183} height={114} style={{margin:'0px 0px 8px'}} />
    <Typography sx={{fontSize:'12px',color:'#0069BA',fontWeight:'bold'}}>Blue Cash Preferred® Card from American Express</Typography>
    </> ,
   
    <><Rating name="read-only" value={4.5} readOnly  precision={0.5} /><br/><Typography sx={{color:'#4B5155',fontSize:'12px'}}>Best grocery rewards credit card</Typography></>,      
    ...
    //  Row 6
    createData( <><img src={gold_card_default_logo} alt="img" width={183} height={114} style={{margin:'0px 0px 8px'}} />
    <Typography sx={{fontSize:'12px',color:'#0069BA',fontWeight:'bold'}}>American Express® Gold Card</Typography>
    </> ,
   
    <><Rating name="read-only" value={4.5} readOnly  precision={0.5} /><br/><Typography sx={{color:'#4B5155',fontSize:'12px'}}>Best dining rewards card</Typography></>,         
     ...
     //  Row 7
    createData( <><img src={discover_it_logo} alt="img" width={183} height={114} style={{margin:'0px 0px 8px'}} />
    <Typography sx={{fontSize:'12px',color:'#0069BA',fontWeight:'bold'}}>Discover it® Secured Credit Card</Typography>
    </> ,
   
    <><Rating name="read-only" value={4.5} readOnly  precision={0.5} /><br/><Typography sx={{color:'#4B5155',fontSize:'12px'}}>Best rewards credit card for bad credit</Typography></>,       
    ...
    //  Row 8
    createData( <><img src={petal_2_default_logo} alt="img" width={183} height={114} style={{margin:'0px 0px 8px'}} />
    <Typography sx={{fontSize:'12px',color:'#0069BA',fontWeight:'bold'}}>Petal® 2 Cash Back, No Fees Visa® Credit Card*</Typography>
    </> ,
   
    <><Rating name="read-only" value={4.5} readOnly  precision={0.5} /><br/><Typography sx={{color:'#4B5155',fontSize:'12px'}}>Best rewards credit card for fair credit</Typography></>,       
    ...
    //  Row 9
    createData(<><img src={savorone_student_logo} alt="img" width={183} height={114} style={{margin:'0px 0px 8px'}} />
    ...
    <><Rating name="read-only" value={4.5} readOnly  precision={0.5} /><br/><Typography sx={{color:'#4B5155',fontSize:'12px'}}>Best student rewards credit card</Typography></>,        
     ...
     //  Row 10
    createData( <><img src={visa_signature_logo} alt="img" width={183} height={114} style={{margin:'0px 0px 8px'}} />
    <Typography sx={{fontSize:'12px',color:'#0069BA',fontWeight:'bold'}}>Prime Visa*</Typography>
    </> ,
   
    <><Rating name="read-only" value={4.5} readOnly  precision={0.5} /><br/><Typography sx={{color:'#4B5155',fontSize:'12px'}}>Best Amazon rewards credit card</Typography></>,       
         ...
         <Typography sx={{ fontSize: '12px', fontFamily: "'Lato', sans-serif'", color: '#687073', marginTop: '5px' }}>on Chase's secure site</Typography>
           ...
           //  Row 11
    createData( <><img src={chase_sapphire_preferred_default_logo} alt="img" width={183} height={114} style={{margin:'0px 0px 8px'}} />
    <Typography sx={{fontSize:'12px',color:'#0069BA',fontWeight:'bold'}}>Chase Sapphire Preferred® Card</Typography>
    </> ,
   
    <><Rating name="read-only" value={4.5} readOnly  precision={0.5} /><br/><Typography sx={{color:'#4B5155',fontSize:'12px'}}>Best runner-up travel rewards credit card</Typography></>,       
         ...
         <Typography sx={{ fontSize: '12px', fontFamily: "'Lato', sans-serif'", color: '#687073', marginTop: '5px' }}>on Chase's secure site</Typography>
           ...
           //  Row 12
    createData(<><img src={hilton_honors_default_logo} alt="img" width={183} height={114} style={{margin:'0px 0px 8px'}} />
    <Typography sx={{fontSize:'12px',color:'#0069BA',fontWeight:'bold'}}>Hilton Honors American Express Surpass® Card</Typography>
    </> ,
   
    <><Rating name="read-only" value={4.5} readOnly  precision={0.5} /><br/><Typography sx={{color:'#4B5155',fontSize:'12px'}}>Best hotel rewards credit card</Typography></>,       
         ...
         <Button variant="text" style={{ fontSize: '12px', fontFamily: "'Lato', sans-serif'", color: '#0069BA', textTransform: 'none' }}>Rates & Fees</Button></>
           ...
           //  Row 13
    createData( <><img src={aadvantage_aviator_logo} alt="img" width={183} height={114} style={{margin:'0px 0px 8px'}} />
    <Typography sx={{fontSize:'12px',color:'#0069BA',fontWeight:'bold'}}>AAdvantage® Aviator® Red World Elite Mastercard®*</Typography>
    </> ,
   
    <><Rating name="read-only" value={4.5} readOnly  precision={0.5} /><br/><Typography sx={{color:'#4B5155',fontSize:'12px'}}>Best airline rewards credit card</Typography></>,       
         ...
         <Typography sx={{ fontSize: '12px', fontFamily: "'Lato', sans-serif'", color: '#687073', marginTop: '5px' }}>on Barclays's secure site</Typography>
           ...
           //  Row 14
    createData( <><img src={ventureOne_logo} alt="img" width={183} height={114} style={{margin:'0px 0px 8px'}} />
    <Typography sx={{fontSize:'12px',color:'#0069BA',fontWeight:'bold'}}>Capital One VentureOne Rewards Credit Card</Typography>
    </> ,
   
    <><Rating name="read-only" value={4.5} readOnly  precision={0.5} /><br/><Typography sx={{color:'#4B5155',fontSize:'12px'}}>Best travel card with no fee</Typography></>,       
