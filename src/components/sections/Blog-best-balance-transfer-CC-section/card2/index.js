...
import { Card, Typography, Button, Grid, Box, Paper, Link, useTheme, Container } from '@mui/material';
...
const cardData = [
  {
    ...
    introAPR: "of 0% intro apr for 18 months on balance transfers, then 19.24% - 29.24% (variable).",
    regularBalanceTransferAPR: "19.24% - 29.24% (Variable)",
    rewardsRate: "Earn 2% on every purchase with unlimited 1% cash back when you buy, plus an additional 1% as you pay for those purchases. To earn cash back, pay at least the minimum due on time. Plus, for a limited time, earn 5% total cash back on hotel, car rentals and attractions booked on the Citi Travel℠ portal through 12/31/24.",
    annualFee: "There is an intro balance transfer fee of 3% of each transfer (minimum $5) completed within the first 4 months of account opening. A balance transfer fee of 5% of each transfer ($5 minimum) applies if completed after 4 months of account opening.",
    ...
    whyWeLikeIt: "The Citi Double Cash® Card stands out as one of the top cash back balance transfer cards available. It not only offers an extended introductory APR on balance transfers but also provides an impressive cash back rate. You can earn a total of 2% cash back on every purchase: 1% when you make a purchase and an additional 1% when you pay for those purchases, with no limit on the cash back you can earn. Just ensure you pay at least the minimum due on time to qualify for cash back. Additionally, for a limited period, you can earn 5% total cash back on hotel stays, car rentals, and attractions booked through the Citi Travel℠ portal until 12/31/24.",
    cardDetails: [
  ...
  },
  {
    ...
    buttontypo: "on Citibank's secure site",
    introAPR: "of 0% intro apr for 21 months on balance transfers, then 19.24% - 29.99% (variable).",
    regularBalanceTransferAPR: "19.24% - 29.99% (Variable)",
    rewardsRate: "N/A",
    annualFee: "There is an intro balance transfer fee of 3% of each transfer (minimum $5) completed within the first 4 months of account opening. Then a balance transfer fee applies with this offer 5% of each balance transfer; $5 minimum.",
    ...
    disclaimer: "*The details regarding the Citi Simplicity® Card have been gathered by LendingTree and have not undergone review or provision by the card issuer prior to publication. Terms and conditions apply."
  }
  ,
  {
    id: 3,
    ...
    buttontypo: "on Citibank's secure site",
    introAPR: "0% Intro APR for 18 billing cycles for any balance transfers made in the first 60 days, then 16.24% - 26.24% Variable APR.",
    ...
    disclaimer: "*The details regarding the BankAmericard® Credit Card for Students have been compiled by LendingTree and have not undergone review or provision by the card issuer prior to publication. Terms and conditions apply."
  }
  ,
  {
    id: 4,
    ...
    introAPR: "0% Intro APR for 15 billing cycles for any balance transfers made in the first 60 days, then 19.24% - 29.24% Variable APR on balance transfers.",
    regularBalanceTransferAPR: "19.24% - 29.24% Variable APR on balance transfers",
    ...
    whyWeLikeIt: "The Bank of America® Unlimited Cash Rewards credit card offers an extended introductory period for both balance transfers and purchases. Moreover, it remains a valuable asset even after clearing your balance transfer, courtesy of its unlimited 1.5% cash back on all purchases.",
    cardDetails: [
  ...
  ,
  {
    ...
    buttontypo: "on Bank Of America's secure site",
    introAPR: "0% Intro APR for 15 billing cycles for any balance transfers made in the first 60 days Then, a 19.24% - 29.24% Variable APR on balance transfers applies",
    regularBalanceTransferAPR: "19.24% - 29.24% Variable APR on balance transfers",
    rewardsRate: "3% cash back in the category of your choice. 2% cash back at grocery stores and wholesale clubs for the first $2,500 in combined choice category/grocery store/wholesale club quarterly purchases. 1% cash back on all other purchases.",
    annualFee: "3% for 60 days from account opening, then 4%",
    recommendedCredit: "660-850 Good/Excellent",
    pros: [
      ...
      <Card key={card.id} sx={{ margin: '20px auto', padding: '20px', boxShadow: 3 }}>
        ...
        <Grid container spacing={2}>
          <Grid item lg={4} xl={4} md={4} xs={12} sm={4} display="flex" alignItems="flex-start" justifyContent="flex-start" flexDirection="column">
            {card.image && <img src={card.image} alt="Card image" width={183} height={114} />}
            ...
            <Grid item lg={8} xl={8} md={8} xs={12} sm={8}>
              ...
              >
                <Grid container spacing={2} justifyContent="space-around">
                  ...
                  <Grid item xs={12} sm={6} md={3} sx={{ textAlign: 'left' }}>
                    <Typography sx={{ fontSize: '12px', color: '#848E92', fontWeight: 'bold' }}>Balance Transfer Fee</Typography>
