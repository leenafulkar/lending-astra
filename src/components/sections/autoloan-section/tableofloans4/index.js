...
const rows = [
  ...
  createData(
    <img src={Autopay_logo} alt="img" width={150} height={33} />,
  ...
  createData(
    <img src={Bankofamerica_logo} alt="img" width={150} height={67} />,
    <Typography sx={{ fontSize: "14px" }}>
  ...
  createData(
    <img src={Capitalone_logo} alt="img" width={150} height={54} />,
  ...
  createData(
    <img src={PNC_logo} alt="img" width={150} height={89} />,
  ...
  createData(
    <img src={DCU_logo} alt="img" width={150} height={53} />,
  ...
  createData(
    <img src={Carvana_logo} alt="img" width={150} height={34} />,
  ...
  createData(
    <img src={Lightstream_logo} alt="img" width={160} height={40} />,
  ...
  createData(
    <img src={Chase_logo} alt="img" width={150} height={28} />,
    ...
    ------------------------------------------------------------- */}
      ...
      >
        <Box>
          ...
          >
            Learn more about{" "}
            <span style={{ color: "#00AEEF" }}> how we chose </span>the best
            auto loans.
          </Typography>
        </Box>
      </Container>
